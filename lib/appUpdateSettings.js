...
async function patchAppUpdateSettings(body) {
  ...
  // `currentVersion` is considered a "code-defined" value; do not allow updating it via Admin UI.
  // It can still be updated via internal/admin scripts by directly updating the DB if needed.
